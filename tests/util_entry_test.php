...
require_once __DIR__ . '/../util_entry.php'; // RED: does not exist yet

// parseEntryLine â€” old Sheet format
...
// sortAndDeduplicateCsv â€” delete marker removes entry
$rawDel = implode("\n", [
